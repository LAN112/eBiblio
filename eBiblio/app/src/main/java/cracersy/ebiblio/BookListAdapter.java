...
public class BookListAdapter extends RecyclerView.Adapter {
    ...
    public BookListAdapter(ArrayList<JSONObject> pArticles, RecyclerView pRecyclerView, Context ctx, String id_user){
        mArticles = pArticles;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        ((MyViewHolder) viewHolder).mTitle.setText(object.optString("tytul"));
        ((MyViewHolder) viewHolder).mContent.setText(object.optString("autor"));
    }
