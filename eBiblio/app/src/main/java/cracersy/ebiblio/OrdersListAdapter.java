...
public class OrdersListAdapter extends RecyclerView.Adapter {
    ...
    public OrdersListAdapter(ArrayList<JSONObject> pArticles, RecyclerView pRecyclerView, Context ctx){
        mArticles = pArticles;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, final int i) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String id_order=mArticles.get(position).optString("id_order");

                Intent Intent = new Intent(mRecyclerView.getContext(), OrderDetails.class);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        ((MyViewHolder) viewHolder).mTitle.setText("Numer zamówienia: " +(object.optString("id_order")));
        ((MyViewHolder) viewHolder).mContent.setText("Data zamówienia: " +(object.optString("data_zamowienia")));
    }
